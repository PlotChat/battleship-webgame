...
export function PickPage({
	...
	const playButton = new Button({
		content: "Play",
		variant: "",
		callback: playButtonTrigger,
	});
	playButton.classList.add("gameplay-page__play-button");
	...
	gameplayPage.append(titleWrapper, arenaBoard, playButton, tools);
	return gameplayPage;
}
